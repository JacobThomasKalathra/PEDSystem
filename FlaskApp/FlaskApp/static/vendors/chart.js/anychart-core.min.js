...
wl=function(a,b){$.nd.call(this);this.g=a;this.K=b;this.Y=maa.test($.kl.location.hostname);this.F=!(this.K||this.Y);this.J=ll|ml|ul|vl};xl=function(){return("https:"==$.kl.location.protocol?"https://":"http://")+""};
